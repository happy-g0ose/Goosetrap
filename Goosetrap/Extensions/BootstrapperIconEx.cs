...
namespace Goosetrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            //BootstrapperIcon.IconGoosetrap,
            BootstrapperIcon.IconGoosetrap,
            ...
            BootstrapperIcon.IconGoosetrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconGoosetrap;
            }

            return icon switch
            {
                //BootstrapperIcon.IconGoosetrap => Properties.Resources.IconGoosetrap,
                BootstrapperIcon.IconGoosetrap => Properties.Resources.IconGoosetrap,
                ...
                BootstrapperIcon.IconGoosetrapClassic => Properties.Resources.IconGoosetrapClassic,
                _ => Properties.Resources.IconGoosetrap
            };
        }
    }
}

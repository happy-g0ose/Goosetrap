...
using Goosetrap.Models.APIs;
using Goosetrap.Models.APIs.RoValra;
using CommunityToolkit.Mvvm.Input;

namespace Goosetrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for Goosetraprpc, discord rich presence, or game history

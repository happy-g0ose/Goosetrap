...
namespace Goosetrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Goosetrap-QA";
#else
        public const string ProjectName = "Goosetrap";
#endif
        ...
        public const string ProjectRemoteDataLink = "https://config.Goosetrap.app/v1/Data.json";
        ...
        public static readonly JsonManager<AccountsState> Accounts = new();

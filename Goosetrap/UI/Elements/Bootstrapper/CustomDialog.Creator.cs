...
namespace Goosetrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["GoosetrapCustomBootstrapper"] = HandleXmlElement_GoosetrapCustomBootstrapper_Fake,
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "GoosetrapCustomBootstrapper")
                throw new Exception("XML root is not a GoosetrapCustomBootstrapper");

            if (xml.Attribute("Version")?.Value != Version.ToString())
                throw new Exception("Unknown GoosetrapCustomBootstrapper version");
            ...
            // handle root
            HandleXmlElement_GoosetrapCustomBootstrapper(this, xml);

...
using Goosetrap.UI.ViewModels.Bootstrapper;
...
namespace Goosetrap.UI.Elements.Bootstrapper
{
    ...
    public partial class ByfronDialog : IBootstrapperDialog
    {
        ...
        public Goosetrap.Bootstrapper? Bootstrapper { get; set; }
        ...
        public ByfronDialog()
        {
            ...
            if (App.Settings.Prop.Theme.GetFinal() == Theme.Light)
            {
                ...
                _viewModel.ByfronLogoLocation = new BitmapImage(new Uri("pack://application:,,,/Resources/BootstrapperStyles/ByfronDialog/ByfronLogo.png"));
            }

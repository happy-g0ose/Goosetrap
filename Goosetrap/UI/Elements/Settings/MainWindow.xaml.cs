...
namespace Goosetrap.UI.Elements.Settings
{
    /// <summary>
    ...
    public partial class MainWindow : INavigationWindow
    {
        ...
        public MainWindow(bool showAlreadyRunningWarning)
        {
            ...
            // Пробуем перезагрузить GBS — файл мог появиться после первого запуска Roblox
            if (!App.GlobalSettings.Loaded)
                App.GlobalSettings.Load();

            bool gbsEnabled = App.GlobalSettings.Loaded;
            gbs.Opacity = gbsEnabled ? 1 : 0.5;
            gbs.IsEnabled = gbsEnabled;
